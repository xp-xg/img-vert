          ...
          <footer className="mt-12 py-10 border-t border-gray-200 dark:border-gray-800">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-10 text-left">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white mb-4">{t('help')}</h3>
                  <ul className="space-y-2">
                    <li><a href="/about" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">{t('about')}</a></li>
                    <li><a href="/contact" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">{t('contact')}</a></li>
                    <li><a href="/privacy" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">{t('privacyPolicy')}</a></li>
                    <li><a href="/terms" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">{t('termsOfService')}</a></li>
                  </ul>
                </div>
              </div>
